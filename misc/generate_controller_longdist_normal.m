function generate_controller_longdist_normal()
...
%controller variables
    controller.name = 'controller_attposition_9_longdist'; %name of controller, will be saved under /controller directory
