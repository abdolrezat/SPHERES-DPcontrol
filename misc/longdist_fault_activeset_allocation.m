function longdist_fault_activeset_allocation()
...
%simulator variables
    ...
    simulator_opts.thruster_allocation_mode = 'saturate-only'; %'active set discrete'; % {'active set discrete', 'PWPF', 'Schmitt', 'none'}
