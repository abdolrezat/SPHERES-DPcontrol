function fault_thr2_Dynamic_Programming(varargin)
...
for r= [-3,-5]
    dr0 = [0 -r 0]; %initial relative position offset
    dv0 = [0 0 0]; %initial relative velocity offset
    q0 = flip(angle2quat(deg2rad(20),deg2rad(40),deg2rad(50))); %initial angles offset (yaw,pitch,roll)
