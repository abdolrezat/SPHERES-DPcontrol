function plot_results_export_case_4(obj)
...
LineWidth_1_angle = 1.1;
LineWidth_3_angle = 1.6;
LineWidth_2_angle = 3.5;
...
plot3(T_ode45, X_ode45(:,11)*180/pi,T_ode45*0+1,style_1_w,'Color', [col_1_w col_1_w col_1_w], 'LineWidth', LineWidth_1_w)
...
plot3(T_ode45, X_ode45(:,13)*180/pi,T_ode45*0+1.5,style_3_w,'Color', [col_3_w col_3_w col_3_w], 'LineWidth', LineWidth_3_w)
grid on
legend('\omega_1','\omega_2','\omega_3')

xlabel('Time [sec]')
ylabel('Angular Velocity [deg/s]')
set(gca, 'View', [0 90],'TickDir','out', 'Box', 'off', 'GridLineStyle', gridLineStyle, 'GridAlpha', gridAlpha)
...
plot3(T_ode45, eul(:,1)*180/pi,T_ode45*0 +1,style_1_angle,'Color', [col_1_angle col_1_angle col_1_angle], 'LineWidth', LineWidth_1_angle)
%         title('quat to eul')

hold on
plot(T_ode45, eul(:,2)*180/pi,style_2_angle,'Color', [col_2_angle col_2_angle col_2_angle], 'LineWidth', LineWidth_2_angle)
plot3(T_ode45, eul(:,3)*180/pi,T_ode45*0+1.5,style_3_angle,'Color', [col_3_angle col_3_angle col_3_angle], 'LineWidth', LineWidth_3_angle)
grid on
legend('\phi','\theta','\psi')
